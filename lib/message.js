...
function Powerdrill(apiKey, template) {
  ...
  this._attachments = [];
  this._merge_language = 'mailchimp';
}
...
Powerdrill.prototype.bcc = function(email) {
  this._bcc = email;
  return this;
};
...
Powerdrill.prototype.mergeLanguage = function(mergeLanguage) {
  this._merge_language = mergeLanguage;
...
Powerdrill.prototype.requestData = function() {
  var data = {
    ...
    message: {
      ...
      merge_language : this._merge_language
    }
  };
